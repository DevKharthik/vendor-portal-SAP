...
const ENTITY_SET = 'ZVENDOR_AGINGSet';
const SAP_CREDS = {
  username: 'K901564',
  password: '06-Aug-030',
};
...
router.get('/:vendorId', async (req, res) => {
  ...
  Lifnr: entry.Lifnr,     // Vendor Code
  Belnr: entry.Belnr,     // Invoice Number
  Gjahr: entry.Gjahr,     // Fiscal Year
  Buzei: entry.Buzei,     // Line Item
  Wrbtr: entry.Wrbtr,     // Amount
  Zfbdt: entry.Zfbdt,     // Payment Due Date
  Budat: entry.Budat,     // Posting Date
  Waers: entry.Waers,     // Currency
  Bldat: entry.Bldat,     // Document Date
  Aging: entry.Aging      // Aging date or duration
